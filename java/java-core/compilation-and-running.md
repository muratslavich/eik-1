...
_**-classpath .**_ указывает на текущий каталог, можно опустить
...
_**-d folder**_ указывает папку для бинарников
...
_**-sourcepath ./src**_ путь к исходникам необходимых для компиляции
